...
class Appbutton {
  primaryButton({
    ...
    IconData prefixIconData = Icons.arrow_forward,
    FontWeight fontWeight = FontWeight.w700,
    double borderradius = 30,
    Color backGroundColor = AppColors.primaryColor,
    Color fontColor = AppColors.background,
  }) {
        ...
        child: Container(
          ...
          child: isPrefixIcon
              ...
              : Center(
                  ...
                  title,
                  fontsize:
                      fontsize == 0 ? AppConfig(context).width / 30 : fontsize,
                  fontweight: fontWeight,
                  color: fontColor,
                )),
        ),
  ...
  static socialRoundButton(
      {required BuildContext context,
      required GestureTapCallback onPressed,
      String iconPath = "assets/logo/facebook.png"}) {
    return InkWell(
      onTap: onPressed,
      child: Container(
        height: AppConfig(context).width * 0.18,
